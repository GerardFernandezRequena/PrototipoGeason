            ...
            <table id="table_id" class="display">
                <thead>
                    <tr>
                        ...
                        <th>Nom usuari</th>
                        <th>Correu usuari</th>
                        <th>Contrasenya usuari</th>
                        <th>Imatge usuari</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    $sql = "SELECT * FROM "._TABLESUSUARI." WHERE activeuser = 1";
                    ...
                    if(!$result){
                        ...
                        if($result ->num_rows != 0){
                            while($row=$result->fetch_array()){
                                ...
                                echo "<td>".$row["passworduser"]."</td>";
                                echo "<td>".$row["imguser"]."</td>";
                                echo "</tr>";
                            }
                        } else {
                            echo "<tr>";
                            echo "<td><p class='h5 text-danger'>No hi han registres d'usuaris/p></td>";
                            echo "</tr>";
                        }
                    }
                ?>
